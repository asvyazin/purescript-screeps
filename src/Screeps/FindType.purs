...
instance showFindType :: Show (FindType a) where
  ...
  show f
    | f === find_exit_right = "find_exit_right"
  show f
    | f === find_exit_bottom = "find_exit_bottom"
  show f
    | f === find_exit_left = "find_exit_left"
  show f
    | f === find_exit = "find_exit"
  show f
    | f === find_creeps = "find_creeps"
  show f
    | f === find_my_creeps = "find_my_creeps"
  show f
    | f === find_hostile_creeps = "find_hostile_creeps"
  show f
    | f === find_sources_active = "find_sources_active"
  show f
    | f === find_sources = "find_sources"
  show f
    | f === find_dropped_energy = "find_dropped_energy"
  show f
    | f === find_dropped_resources = "find_dropped_resources"
  show f
    | f === find_structures = "find_structures"
  show f
    | f === find_my_structures = "find_my_structures"
  show f
    | f === find_hostile_structures = "find_hostile_structures"
  show f
    | f === find_flags = "find_flags"
  show f
    | f === find_construction_sites = "find_construction_sites"
  show f
    | f === find_my_spawns = "find_my_spawns"
  show f
    | f === find_hostile_spawns = "find_hostile_spawns"
  show f
    | f === find_my_construction_sites = "find_my_construction_sites"
  show f
    | f === find_hostile_construction_sites = "find_hostile_construction_sites"
  show f
...
instance showLookType :: Show (LookType a) where
  ...
  show f
    | f =-= look_energy = "look_energy"
  show f
    | f =-= look_resources = "look_resources"
  show f
    | f =-= look_sources = "look_sources"
  show f
    | f =-= look_minerals = "look_minerals"
  show f
    | f =-= look_structures = "look_structures"
  show f
    | f =-= look_flags = "look_flags"
  show f
    | f =-= look_construction_sites = "look_construction_sites"
  show f
